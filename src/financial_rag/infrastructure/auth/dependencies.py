...
Usage in endpoints::
    ...
    from financial_rag.infrastructure.auth.dependencies import require_auth, require_admin, require_upload
...
from financial_rag.infrastructure.auth.models import Role
