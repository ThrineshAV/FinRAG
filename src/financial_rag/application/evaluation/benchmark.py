...
from financial_rag.application.evaluation.metrics import (
    EvaluationCase,
...
BENCHMARK_PATH = Path(__file__).resolve().parents[3] / "data" / "evaluation.json"
...
def _run_with_generation(cases: list[EvaluationCase]) -> dict:
    ...
    from financial_rag.infrastructure.llm.llm import generate_answer_grounded
